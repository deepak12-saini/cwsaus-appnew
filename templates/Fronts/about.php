...
<section id="bannerseciner">
  <div class="container">
    <div class="col-md-12 bnrtxtsecinr wow zoomIn" data-wow-duration="1.8s" data-wow-delay="0.0s">
      <h1><?= h($menu && ($menu->banner_title ?? $menu->title) ? ($menu->banner_title ?? $menu->title) : 'About Us') ?></h1>
      ...
      <div class="contcttpsc">
        <div class="col-md-12">
          <div class="title-area">
            <h2 class="title"><?= h($menu && ($menu->main_title ?? $menu->title) ? ($menu->main_title ?? $menu->title) : 'About Us') ?></h2>
