            ...
            <div class="blog-archive-left">
              <article class="blog-news-single">
                ...
                <div class="blog-news-details">
                  <?= $blog->description ? $this->Text->autoParagraph(h($blog->description)) : '' ?>
                </div>
              </article>
            </div>
          </div>
              ...
              <div class="sidebar-widget">
                <form action="<?= $this->Url->build(['controller' => 'Blogs', 'action' => 'index']) ?>" method="GET">
                  <div class="search-group">
                    <input placeholder="Search" type="search" name="title">
              ...
              <div class="sidebar-widget">
                ...
                <ul class="widget-catg">
                  <?php if ($RecentBlogs && $RecentBlogs->count() > 0): ?>
                    ...
                    <?php endforeach; ?>
                  <?php else: ?>
                  <li><a href="<?= $this->Url->build(['controller' => 'Blogs', 'action' => 'index']) ?>">View all posts</a></li>
                  <?php endif; ?>
                </ul>
              </div>
            </aside>
