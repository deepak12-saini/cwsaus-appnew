...
Kirki::add_field( 'infinity', array(
	...
	'description' => esc_html__( 'Turn on this option if you want to enable sticky header on your site', 'tm-renovation' ),
	'section'     => $section,
	'priority'    => $priority ++,
...
Kirki::add_field( 'infinity', array(
	...
	'output'    => array(
		array(
			'element'  => '.header01 #site-navigation .menu > ul > li > a, .header01  #site-navigation .menu > li > a,
