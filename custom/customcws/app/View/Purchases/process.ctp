	...
	<div class="row">
		...
		<?php echo $this->Form->create('Purchase',array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
			...
			<div class="form-group reminder">
				...
				<div class="col-sm-9">
					<label class="block">
						<input type="radio" id="status_0" name="data[Purchase][status]" <?php if($PurchaseArr['Purchase']['status'] == 0){ echo 'selected'; } ?> value="0" checked class="ace input-lg"> <span class="lbl bigger-120"> Pending </span>
					</label>
					<label class="block">
						<input type="radio" id="status_1"  name="data[Purchase][status]"  <?php if($PurchaseArr['Purchase']['status'] == 1){ echo 'selected'; } ?> value="1" class="ace input-lg"> <span class="lbl bigger-120"> Approved</span>
					</label>					
