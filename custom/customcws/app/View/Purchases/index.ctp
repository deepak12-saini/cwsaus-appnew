	<div class="page-content">
		<div class="page-header">
			<h1>Purchase List
				<a href="<?php echo SITEURL.'purchases/add'?>" class="btn btn-xs btn-info" >Add New Requisition</a>
			</h1>
		</div>
					...
					<tr>
						...
						<td>							
							...
							?>
								...
								<?php $id = $this->Session->read('Customer.id');
								if($purchaseArrs['Purchase']['prepared_by'] == $id){ 
								?>
				...
				<div class="col-xs-12">
					...
					<table class="table table-striped table-bordered table-hover" id="simple-table" >
						<tbody>						
							...
							<tr><th>status: </th>
							<td>
							<?php if($purchaseArrs['Purchase']['status'] == 0){ echo '<span class="label label-info">Pending</span>'; }else if($purchaseArrs['Purchase']['status'] == 1){ echo '<span class="label label-success">Approved</span>'; }else if($purchaseArrs['Purchase']['status'] == 2){ echo '<span class="label label-success">Received</span>'; } ?>
							</td></tr>					
						</tbody>						
					</table>	
					<?php 
					...
					<table class="table table-striped table-bordered table-hover" id="simple-table" >
						<tbody>					
							...
							<?php if(!empty($PurchaseRequirement['purpose_project'])){ ?>
