	...
	<div class="row">
		...
		<?php echo $this->Form->create('Client',array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<?php echo $this->Form->input('ClientType.name',array('div'=>false,'label'=>false, 'class' => 'col-xs-10 col-sm-5','id'=>'name','placeholder'=>'Client Category Name','value'=>$ClientTypeArr['ClientType']['name']))?>&nbsp;
