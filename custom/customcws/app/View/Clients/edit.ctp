	...
	<div class="page-content">
		...
		<div class="right_btn pull-right" ><a href="<?php echo SITEURL.'clients'?>" class="btn btn-inverse" >Back</a></div>
	...
	<div class="row">
		<div class="col-xs-12">
		<?php echo $this->Form->create('Client',array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
			...
			<div class="form-group">
				...
				<input type="radio" value="1"  <?php if($clientArr['Client']['status'] == 1){ echo 'checked'; } ?> class="ace" id="CategoryActive1" name="data[Client][status]"><span class="lbl"> Active</span>
				</label></div>
				
				<div class="radio"><label>
					<input type="radio" value="0"  <?php if($clientArr['Client']['status'] == 0){ echo 'checked'; } ?>   class="ace" id="CategoryActive0" name="data[Client][status]"><span class="lbl"> Inactive</span>
				</label></div>				
				</div>
			</div>
			<div class="form-group">
