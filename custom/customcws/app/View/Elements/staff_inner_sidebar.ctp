			...
			<ul class="nav nav-list">
				...
				<li class="<?php if ($this->params['controller']=='mailers' && $this->params['action']=='index') {echo 'active';}?>">
					<a href="<?php echo SITEURL?>mailers">
						...
						<span class="menu-text">EOI Emailer </span></b>
					</a>

				</li>
				<li class="<?php if ($this->params['controller']=='mailers' && $this->params['action']=='welcomemailer') {echo 'active';}?>">
					<a href="<?php echo SITEURL?>mailers/welcomemailer">
						<i class="menu-icon fa fa-envelope"></i>
						<span class="menu-text">Welcome Emailer </span></b>
					</a>

				</li>
				<li class="<?php if ($this->params['controller']=='estimators' && $this->params['action']=='index') {echo 'active';}?>">
					<a href="<?php echo SITEURL?>estimators/index">
