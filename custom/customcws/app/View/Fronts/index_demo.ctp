...
<div class="banner col-lg-12 col-md-12 col-sm-12">
	...
	<div id="slider">
	<figure>
	<img src="<?php echo SITEURL ;?>customdurotech/images/slider/banner_1.png" alt>
	<img src="<?php echo SITEURL ;?>customdurotech/images/slider/banner_2.png" alt>
	<img src="<?php echo SITEURL ;?>customdurotech/images/slider/banner_3.png" alt>
	<img src="<?php echo SITEURL ;?>customdurotech/images/slider/banner_4.png" alt>
	<img src="<?php echo SITEURL ;?>customdurotech/images/slider/banner_5.png" alt>
	</figure>
	</div>
</div>
	...
	<div class="content col-lg-12 col-md-12 col-sm-12">
		 ...
		 <p>Durotech Technologies is an Australian Made and Owned solutions orientated technologist who specialises in the supply and manufacture of market leading elastomeric and cementitious coating technologies.</p>
			       ...
			       <div class="card slide-up col-lg-4 col-md-4 col-sm-4" id="duroprodcut">
				    ...
				    <div class="card slide-up col-lg-4 col-md-4 col-sm-4">
				     ...
				     <div class="card slide-up col-lg-4 col-md-4 col-sm-4">
					  <div class='image'>
						  ...
						  <a href="<?php echo SITEURL.'specification' ?>">View More</a>
					  </div>
					  <div class='caption'>
					...
					<div class="card slide-up col-lg-4 col-md-4 col-sm-4">
					  <div class='image'>
						  ...
						  <h3>Duro Store</h3>
						  <a href="<?php echo SITEURL ?>">View More</a>
					  </div>
					  <div class='caption'>
		...
		<div class="work_with col-lg-12 col-md-12 col-sm-12">
		    <div class="row">
		      <h3>What We Offer</h3>
			  <p>Durotech industries is a leading manufacturer and supplier of waterproofing products. </p>
			  <div class="work_section col-lg-12 col-md-12 col-sm-12">
			         <div class="container">
			         <div class="work_section_img col-lg-6 col-md-6 col-sm-6">
					      <img src="<?php echo SITEURL ;?>customdurotech/images/work_globe.gif">
					 </div>
					 <div class="work_section_content col-lg-6 col-md-6 col-sm-6">
					      <div class="work_section_content_1">
							  ...
							  <p>local and international R&D working and developing end to end systems and solutions.</p>
						  </div>
						  <div class="work_section_content_1">
							  <i class="fa fa-industry" aria-hidden="true"></i>
							  <h4>Local manufacturing</h4>
							  <p>Manufacturing locally makes durotech fast efficient and reliable providing high quality products.</p>
						  </div>
						  <div class="work_section_content_1">
							  <i class="fa fa-headphones" aria-hidden="true"></i>
							  <h4>National and global technical support </h4>
							  <p>National and international projects are handling with great professionalism with or global offices.</p>
						  </div>
						  <div class="work_section_content_1">
							  <i class="fa fa-shopping-cart" aria-hidden="true"></i>
							  <h4>International distribution </h4>
							  <p>Having global distribution networks allows durotech to better serve there local and international clients.</p>
						  </div>
					 </div>
					 </div>
			  </div>
		...
		<div class="mobile_app_section col-lg-12 col-md-12 col-s-12">
		  ...
		  <p>With an Australian wide community that is connected to Durotech for over 40 years, we wish to make the user experience simplified and convenient. 
Download our latest mobile App to know about latest products and waterproofing solutions from Durotech Industries. </p>
          </div>
		...
		<!-- LightWidget WIDGET --><!--script src="http://lightwidget.com/widgets/lightwidget.js"></script><iframe src="http://lightwidget.com/widgets/6b59d0e0b09e59d1bbfadd63c7a3ed43.html" scrolling="no" allowtransparency="true" class="lightwidget-widget" style="width: 100%; border: 0; overflow: hidden;"></iframe-->
	    ...
	    <div class="row">
			...
			?>
			 <div class="card">
				  <div class="content">
					<div class="front">
					  <a href="<?php echo $linknew ;?>" target="_blank"><img src="<?php echo $img[1] ;?>"></a>
					</div>
					<div class="back">
					  <a href="<?php echo $linknew ;?>"  target="_blank"><img src="<?php echo $img[1] ;?>"></a>
					</div>
		...
		<style>
			iframe .lightwidget--grid.lightwidget--image-format-original .lightwidget__image {
				bottom: 50%;
				/* max-height: 100%; */
