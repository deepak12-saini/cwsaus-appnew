		...
		<div class="col-xs-12">
			...
			<?php echo $this->Form->create('DocumentFieldExecutiveDuty',array('class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data'));?>	
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php echo $this->Form->input('DocumentFieldExecutiveDuty.documentid',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'col-xs-10 col-sm-5','id'=>'documentid','placeholder'=>'Document Id','readonly'=>true,'style'=>'background-color: #ddd !important;'))?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php echo $this->Form->input('DocumentFieldExecutiveDuty.date_of_visit',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'datepicker col-xs-10 col-sm-5','id'=>'date_of_visit','placeholder'=>'Date of Visit'))?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<select name="data[DocumentFieldExecutiveDuty][priority]">
							...
							<option <?php if($docArr['DocumentFieldExecutiveDuty']['priority'] == 'Normal'){ echo 'selected'; } ?> value="Normal">Normal</option>
							<option <?php if($docArr['DocumentFieldExecutiveDuty']['priority'] == 'Urgent'){ echo 'selected'; } ?>   value="Urgent">Urgent</option>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php echo $this->Form->input('DocumentFieldExecutiveDuty.particular_contact_no',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'col-xs-10 col-sm-5','id'=>'particular_contact_no','placeholder'=>'contact number'))?>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php echo $this->Form->input('DocumentFieldExecutiveDuty.dept_date_of_visit',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'datepicker col-xs-10 col-sm-5','id'=>'dept_date_of_visit','placeholder'=>'Dept. date of visit'))?>
					</div>
				</div>
