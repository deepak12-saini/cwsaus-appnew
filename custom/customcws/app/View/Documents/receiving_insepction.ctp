	<div class="page-content">
		<div class="page-header">
			<h1>Document Receive Inspection List <a href="<?php echo SITEURL.'documents/add_receiving_insepction' ?>" class="btn btn-mini btn-primary"> Add New</a></h1>
		</div>
			...
			<table class="table table-striped table-bordered table-hover" id="simple-table" >
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="<?php echo SITEURL.'documents/edit_receiving_insepction/'.$DocumentLibraryArrs['DocumentReceiveInspection']['id']; ?>" class="btn btn-mini btn-info">Edit</a>							
