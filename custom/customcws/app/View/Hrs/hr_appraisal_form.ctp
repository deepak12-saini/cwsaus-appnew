	<div class="page-content">
		<div class="page-header">
			<h1>Hr Performance Appraisal Form <a href="<?php echo SITEURL.'hrs/appraisal_form_add' ?>" class="btn btn-mini btn-primary"> Add New </a></h1>
		</div>
			...
			<table class="table table-striped table-bordered table-hover" id="simple-table" >
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="<?php echo SITEURL.'hrs/appraisal_form_edit/'.$HrPerformanceFeedbackArrs['HrAppraisalForm']['id']; ?>" class="btn btn-mini btn-info">Edit</a>							
