	<div class="page-content">
		<div class="page-header">
			<h1> Hr Format Training Calendars <a href="<?php echo SITEURL.'hrs/format_trainng_calendar_add' ?>" class="btn btn-mini btn-primary"> Add New </a></h1>
		</div>
			...
			<table class="table table-striped table-bordered table-hover" id="simple-table" >
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="<?php echo SITEURL.'hrs/format_trainng_calendar_edit/'.$HrPerformanceFeedbackArrs['HrFormatTrainingCalendar']['id']; ?>" class="btn btn-mini btn-info">Edit</a>							
