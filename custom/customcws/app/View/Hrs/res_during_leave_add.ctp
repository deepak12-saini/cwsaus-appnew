		...
		<div class="col-xs-12">
			...
			<?php echo $this->Form->create('HrDuringLeave',array('class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data'));?>	
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php 						
						echo $this->Form->input('HrDuringLeave.documentid',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'col-xs-10 col-sm-5','id'=>'documentid','placeholder'=>'Documentid','readonly'=>true,'style'=>'background-color: #ddd !important;','value'=>$docId));
						?>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php echo $this->Form->input('HrDuringLeave.leave_from',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'datepicker col-xs-10 col-sm-5','id'=>'leave_from','placeholder'=>'Leave Period From','value'=>date('Y-m-d')))?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Leave Period To: </label>
					<div class="col-sm-9">
						<?php echo $this->Form->input('HrDuringLeave.leave_to',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'datepicker col-xs-10 col-sm-5','id'=>'leave_to','placeholder'=>'Leave Period To','value'=>date('Y-m-d')))?>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<table style=" width:100% !important; ">
							...
							<tbody>
								<tr>									
									<td> <input type="text" name="data[description_of_duty][]"  value=""  placeholder="Description of duty"  required /></td>					
									<td> <input type="text" name="data[description_of_responsibility][]"  value=""  placeholder="Enter responsibility"  required /></td>					
									<td> <input type="text" name="data[handed_over][]"  value=""  placeholder="handed over"  required /></td>					
									<td> <input type="text" name="data[assigned_to][]"  value="" placeholder="Assigned To" required /></td>	
									<td> <input type="text" name="data[signature][]"  value="" placeholder="Signature" required /></td>	
									<th><a style="visibility:hidden;" href="#null" onclick="deletetrow('+n+')"><i class="fa fa-close" style="color:red;"> </i></a> </th>	
								</tr>
