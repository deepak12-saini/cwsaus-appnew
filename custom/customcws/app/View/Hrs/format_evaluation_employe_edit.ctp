		...
		<div class="col-xs-12">
			...
			<?php echo $this->Form->create('HrFormatEvaluationEmployee',array('class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data'));?>	
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php 						
						echo $this->Form->input('HrFormatEvaluationEmployee.documentid',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'col-xs-10 col-sm-5','id'=>'documentid','placeholder'=>'Documentid','readonly'=>true,'style'=>'background-color: #ddd !important;'));
						?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php echo $this->Form->input('HrFormatEvaluationEmployee.date',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'datepicker col-xs-10 col-sm-5','id'=>'date','placeholder'=>'Date'))?>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<table style=" width:100% !important; ">
							...
							<tbody>
								<?php foreach($docArr['HrFormatEvaluationEmployeRecord'] as $docArrs){ ?>
								<tr>									
									<td> <input type="hidden" name="data[detail][]"  value="<?php echo $docArrs['detail']?>"   /> Area of Expertise </td>					
									<td> <input type="text" name="data[acceptable][]"  value="<?php echo $docArrs['acceptable']?>" placeholder="Enter acceptable"    /></td>					
									<td> <input type="text" name="data[not_acceptable][]"  value="<?php echo $docArrs['not_acceptable']?>" placeholder="not acceptable"    /></td>										
									<td> <input type="text" name="data[to_be_improved][]"  value="<?php echo $docArrs['to_be_improved']?>"  placeholder="to be improved"    /></td>										
								</tr>
								<?php } ?>
							</tbody>
