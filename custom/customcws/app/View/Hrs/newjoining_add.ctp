		...
		<div class="col-xs-12">
			...
			<?php echo $this->Form->create('HrNewJoiningDetail',array('class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data'));?>	
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php 						
						echo $this->Form->input('HrNewJoiningDetail.documentid',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'col-xs-10 col-sm-5','id'=>'documentid','placeholder'=>'Documentid','readonly'=>true,'style'=>'background-color: #ddd !important;','value'=>$docId));
						?>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php echo $this->Form->input('HrNewJoiningDetail.date',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'datepicker col-xs-10 col-sm-5','id'=>'date','placeholder'=>'Date','value'=>date('Y-m-d')))?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="checkbox" name="data[HrNewJoiningDetail][term_conditions]" value="1">
					</div>
				</div>
				<div class="form-group">
