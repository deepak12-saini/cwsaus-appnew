		...
		<div class="col-xs-12">
			...
			<?php echo $this->Form->create('HrTrainingAttendance',array('class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data'));?>	
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php 						
						echo $this->Form->input('HrTrainingAttendance.documentid',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'col-xs-10 col-sm-5','id'=>'documentid','placeholder'=>'Documentid','readonly'=>true,'style'=>'background-color: #ddd !important;','value'=>$docId));
						?>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php echo $this->Form->input('HrTrainingAttendance.date',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'datepicker col-xs-10 col-sm-5','id'=>'date','placeholder'=>'Date of Order','value'=>date('Y-m-d')))?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<table style=" width:100% !important; ">
							...
							<tbody>
								<tr>									
									<td> <input type="text" name="data[trainee_name][]"  value=""  placeholder="Enter Trainee Name"  required /></td>					
									<td> <input type="text" name="data[department][]"  value=""  placeholder="Enter Deptarment"  required /></td>					
									<td> <input type="text" name="data[signature][]"  value=""  placeholder="Signature"  required /></td>					
									<td> <input type="text" name="data[date][]"  value="" placeholder="YYYY-MM-DD" required /></td>	
