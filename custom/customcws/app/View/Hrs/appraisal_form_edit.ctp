		...
		<div class="col-xs-12">
			...
			<?php echo $this->Form->create('HrAppraisalForm',array('class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data'));?>	
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php 						
						echo $this->Form->input('HrAppraisalForm.documentid',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'col-xs-10 col-sm-5','id'=>'documentid','placeholder'=>'Documentid','readonly'=>true,'style'=>'background-color: #ddd !important;'));
						?>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php 						
						echo $this->Form->input('HrAppraisalForm.date',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'datepicker col-xs-10 col-sm-5','id'=>'date','placeholder'=>'Date'));
						?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="radio" name="data[HrAppraisalForm][suitable_for_confirmation]" value="Yes" <?php if($docArr['HrAppraisalForm']['suitable_for_confirmation'] == 'Yes'){ ?> checked <?php } ?>> Yes 
						<input type="radio" name="data[HrAppraisalForm][suitable_for_confirmation]" value="No" <?php if($docArr['HrAppraisalForm']['suitable_for_confirmation'] == 'No'){ ?> checked <?php } ?>> No 
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="radio" name="data[HrAppraisalForm][suitable_for_promition]" value="Yes" <?php if($docArr['HrAppraisalForm']['suitable_for_promition'] == 'Yes'){ ?> checked <?php } ?>> Yes 
						<input type="radio" name="data[HrAppraisalForm][suitable_for_promition]" value="No" <?php if($docArr['HrAppraisalForm']['suitable_for_promition'] == 'No'){ ?> checked <?php } ?>> No 
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="radio" name="data[HrAppraisalForm][continue_with_notice]" value="Yes" checked <?php if($docArr['HrAppraisalForm']['continue_with_notice'] == 'Yes'){ ?> checked <?php } ?>> Yes 
						<input type="radio" name="data[HrAppraisalForm][continue_with_notice]" value="No" <?php if($docArr['HrAppraisalForm']['continue_with_notice'] == 'No'){ ?> checked <?php } ?>> No 
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="radio" name="data[HrAppraisalForm][terminate]" value="Yes" <?php if($docArr['HrAppraisalForm']['terminate'] == 'Yes'){ ?> checked <?php } ?>> Yes 
						<input type="radio" name="data[HrAppraisalForm][terminate]" value="No" <?php if($docArr['HrAppraisalForm']['terminate'] == 'No'){ ?> checked <?php } ?> > No 
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<table style=" width:100% !important; ">
							...
							<tbody>
								<?php
									foreach($docArr['HrAppraisalFormRecord'] as $HrAppraisalFormRecord){
								?>
								<tr>									
									<td> <input type="hidden" name="data[performance_criteria][]"  value="<?php echo $HrAppraisalFormRecord['performance_criteria']; ?>"   /> <?php echo $HrAppraisalFormRecord['performance_criteria']; ?> </td>					
									<td> <input type="text" name="data[applicabe_for][]"  value="<?php echo $HrAppraisalFormRecord['applicabe_for']; ?>"  placeholder="Enter Acceptable"    /></td>					
									<td> 
										<select name="data[rating][]">
											<option value="">Choose Rating</option>
											<option value="Excellent" <?php if($HrAppraisalFormRecord['rating'] == 'Excellent'){ echo 'selected'; } ?>>Excellent</option>
											<option value="Very Good" <?php if($HrAppraisalFormRecord['rating'] == 'Very Good'){ echo 'selected'; } ?>>Very Good</option>
											<option value="Good" <?php if($HrAppraisalFormRecord['rating'] == 'Good'){ echo 'selected'; } ?>>Good</option>
											<option value="Average" <?php if($HrAppraisalFormRecord['rating'] == 'Average'){ echo 'selected'; } ?>>Average</option>
											<option value="Poor" <?php if($HrAppraisalFormRecord['rating'] == 'Poor'){ echo 'selected'; } ?>>Poor</option>
											<option value="Worse" <?php if($HrAppraisalFormRecord['rating'] == 'Worse'){ echo 'selected'; } ?>>Worse</option>
										</select>
									</td>										
									<td> <input type="text" name="data[rating_by_appraiser][]"  value="<?php echo $HrAppraisalFormRecord['rating_by_appraiser']; ?>"  placeholder="Rating By Appraiser"    /></td>										
								</tr>
								<?php } ?>
							</tbody>
