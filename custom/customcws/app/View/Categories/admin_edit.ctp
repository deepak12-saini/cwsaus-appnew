	...
	<div class="row">
		<div class="col-xs-12">
			<?php echo $this->Form->create('Category',array('class'=>'form-horizontal','enctype'=>'multipart/form-data'));echo $this->Form->input('id',array('type'=>'hidden')); ?>
				<div class="form-group">
					...
					<div class="col-sm-8">
						<?php echo $this->Form->input('category_name',array('div'=>false,'label'=>false, 'class' => 'col-xs-10 col-sm-5','id'=>'category_name','placeholder'=>'Category Name'))?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="data[Category][meta_title]" id="meta_title" value="<?php echo $Category['Category']['meta_title']; ?>" class="col-xs-10 col-sm-5" placeholder="Meta Title">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Meta Keyword: </label>
					<div class="col-sm-9">
						<input type="text" name="data[Category][meta_keyword]" id="meta_keyword" value="<?php echo $Category['Category']['meta_keyword']; ?>" class="col-xs-10 col-sm-5" placeholder="Meta Keyword">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Meta Description: </label>
					<div class="col-sm-9">
						<textarea name="data[Category][meta_description]" id="meta_description" class="col-xs-10 col-sm-5" placeholder="Meta Description" ><?php echo $Category['Category']['meta_description']; ?></textarea>					
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<br/>
						<p><img src="<?php echo SITEURL.'category/'.$Category['Category']['image']; ?>" /></p>
					</div>
				</div>	
				<div class="form-group">
				...
				<div class="form-group">
					<label for="form-field-2" class="col-sm-3 control-label no-padding-right"> Is Brand: </label>
						<div class="col-sm-9">
						<?php if($Category['Category']['is_brand'] == 1) { $active='checked';$inactive='';}else{  $active='';$inactive='checked';}?>
						
						<div class="radio"><label>
						<input type="radio"  value="1" <?php echo $active; ?>  class="ace" id="ServiceCategoryActive1" name="data[Category][is_brand]"><span class="lbl"> Yes</span>
						</label></div>
						
						<div class="radio"><label>
							<input type="radio" value="0" class="ace" <?php echo $inactive; ?> id="ServiceCategoryActive0" name="data[Category][is_brand]"><span class="lbl"> No</span>
						</label></div>
