...
<div class="page-content">
	...
	<a href="<?php echo SITEURL; ?>admin/audits/circularinternalauditlist" class="btn btn-mini btn-inverse" style="float:right;">Back</a>
	</h1>
	</div><!-- /.page-header -->
	<div class="row">
		<div class="col-xs-12">
			...
			echo $this->Form->create('CircularInternalAudit',array('class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data'));?>	
				...
				<div class="form-group">
					...
					<table>
						...
						<tr>
							...
							<td><input type="text" name="date[0][datetime]" value="<?php if(isset($CircularInternalAuditResult[0]['CircularInternalAuditResult']['date'])){ echo $CircularInternalAuditResult[0]['CircularInternalAuditResult']['date']; } ?>" class="datepicker" placeholder="Select Date"  style="margin:10px;" disabled></td>
							
							<td><input type="text" name="date[0][time]" class="timepicker" value="<?php if(isset($CircularInternalAuditResult[0]['CircularInternalAuditResult']['time'])){ echo $CircularInternalAuditResult[0]['CircularInternalAuditResult']['time']; } ?>"  placeholder="Enter time  08:00 am"  style="margin:10px;" disabled></td>
							<td>
								<select  name="date[0][auditor]"  style="margin:10px;" disabled>
							...
							<td>
								<select name="date[0][auditee]"  style="margin:10px;" disabled>
						...
						<tr>
							...
							<td><input type="text" value="<?php if(isset($CircularInternalAuditResult[1]['CircularInternalAuditResult']['date'])){ echo $CircularInternalAuditResult[1]['CircularInternalAuditResult']['date']; } ?>" name="date[1][datetime]" class="datepicker" placeholder="Select Date"  style="margin:10px;" disabled></td>
							<td><input type="text" class="timepicker" value="<?php if(isset($CircularInternalAuditResult[1]['CircularInternalAuditResult']['time'])){ echo $CircularInternalAuditResult[1]['CircularInternalAuditResult']['time']; } ?>" name="date[1][time]" class="" placeholder="Enter time  08:00 am"  style="margin:10px;" disabled></td>
							<td>
								<select  name="date[1][auditor]"  style="margin:10px;" disabled>
									<option value="">Select Auditor</option>
									<?php foreach($userArr as $userArrs){ ?>
							...
							<td>
								<select name="date[1][auditee]"  style="margin:10px;" disabled>
									<option value="">Select Auditee</option>
									<?php foreach($userArr as $userArrs){ ?>
						...
						<tr>
							...
							<td><input type="text"  value="<?php if(isset($CircularInternalAuditResult[2]['CircularInternalAuditResult']['date'])){ echo $CircularInternalAuditResult[2]['CircularInternalAuditResult']['date']; } ?>"  class="datepicker" placeholder="Select Date"  name="date[2][datetime]" style="margin:10px;" disabled></td>
							
							<td><input type="text" class="timepicker" value="<?php if(isset($CircularInternalAuditResult[2]['CircularInternalAuditResult']['time'])){ echo $CircularInternalAuditResult[2]['CircularInternalAuditResult']['time']; } ?>" name="date[2][time]" class="" placeholder="Enter time  08:00 am"  style="margin:10px;" disabled></td>
							<td>
								<select  name="date[2][auditor]"  style="margin:10px;" disabled>
									<option value="">Select Auditor</option>
									<?php foreach($userArr as $userArrs){ ?>
							...
							<td>
								<select name="date[2][auditee]"  style="margin:10px;" disabled>
									<option value="">Select Auditee</option>
									<?php foreach($userArr as $userArrs){ ?>
						...
						<tr>
						<td>Purchase</td>
							<td><input type="text" value="<?php if(isset($CircularInternalAuditResult[3]['CircularInternalAuditResult']['date'])){ echo $CircularInternalAuditResult[3]['CircularInternalAuditResult']['date']; } ?>"  class="datepicker" placeholder="Select Date"  name="date[3][datetime]" style="margin:10px;" disabled></td>
							<td><input type="text" class="timepicker" value="<?php if(isset($CircularInternalAuditResult[3]['CircularInternalAuditResult']['time'])){ echo $CircularInternalAuditResult[3]['CircularInternalAuditResult']['time']; } ?>" name="date[3][time]" class="" placeholder="Enter time 08:00 am"  style="margin:10px;" disabled></td>
							<td>
								<select  name="date[3][auditor]"  style="margin:10px;" disabled>
									<option value="">Select Auditor</option>
									<?php foreach($userArr as $userArrs){ ?>
							...
							<td>
								<select name="date[3][auditee]"  style="margin:10px;" disabled>
									<option value="">Select Auditee</option>
									<?php foreach($userArr as $userArrs){ ?>
						...
						<tr>
						<td>HR/Training</td>
							<td><input type="text" value="<?php if(isset($CircularInternalAuditResult[4]['CircularInternalAuditResult']['date'])){ echo $CircularInternalAuditResult[4]['CircularInternalAuditResult']['date']; } ?>"  class="datepicker" placeholder="Select Date" name="date[4][datetime]" style="margin:10px;" disabled></td>
							<td><input type="text" class="timepicker" value="<?php if(isset($CircularInternalAuditResult[4]['CircularInternalAuditResult']['time'])){ echo $CircularInternalAuditResult[4]['CircularInternalAuditResult']['time']; } ?>" name="date[4][time]" class="" placeholder="Enter time  08:00 am"  style="margin:10px;" disabled></td>
							<td>
								<select  name="date[4][auditor]"  style="margin:10px;" disabled>
									<option value="">Select Auditor</option>
									<?php foreach($userArr as $userArrs){ ?>
							...
							<td>
								<select name="date[4][auditee]"  style="margin:10px;" disabled>
									<option value="">Select Auditee</option>
									<?php foreach($userArr as $userArrs){ ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php echo $this->Form->input('opening_held_on',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'datepicker col-xs-10 col-sm-5','id'=>'opening_held_on','placeholder'=>'Opening Held On','value'=>$InternalAuditPlan['CircularInternalAudit']['opening_held_on'],'style'=>'background-color: #ddd !important;'))?>
					</div>
				</div>				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Opening Held At: </label>
					<div class="col-sm-9">
						<?php echo $this->Form->input('opening_place_at',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'col-xs-10 col-sm-5','id'=>'opening_place_at','placeholder'=>'Opening Held At','value'=>$InternalAuditPlan['CircularInternalAudit']['opening_place_at'],'style'=>'background-color: #ddd !important;'))?>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php echo $this->Form->input('closing_held_on',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'datepicker col-xs-10 col-sm-5','id'=>'closing_held_on','placeholder'=>'Closing Held On','value'=>$InternalAuditPlan['CircularInternalAudit']['closing_held_on'],'style'=>'background-color: #ddd !important;'))?>
					</div>
				</div>				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Closing Held At: </label>
					<div class="col-sm-9">
						<?php echo $this->Form->input('closing_place_at',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'col-xs-10 col-sm-5','id'=>'closing_place_at','placeholder'=>'Closing Held At','value'=>$InternalAuditPlan['CircularInternalAudit']['closing_place_at'],'style'=>'background-color: #ddd !important;'))?>
					</div>
				</div>
