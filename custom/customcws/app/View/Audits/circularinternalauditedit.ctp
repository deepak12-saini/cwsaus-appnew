...
<div class="page-content">
	...
	<small>
		...
		Update Circular Internal Audit
	</small>
		...
		<div class="col-xs-12">
			...
			<?php echo $this->Form->create('CircularInternalAudit',array('class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data'));?>	
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php echo $this->Form->input('from_mr',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'datepicker col-xs-10 col-sm-5','id'=>'from_mr','placeholder'=>'From MR','value'=>$InternalAuditPlan['CircularInternalAudit']['from_mr']))?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">To MR: </label>
					<div class="col-sm-9">
						<?php echo $this->Form->input('to_mr',array('type'=>'text','div'=>false,'label'=>false, 'class' => 'datepicker col-xs-10 col-sm-5','id'=>'to_mr','placeholder'=>'To MR','value'=>$InternalAuditPlan['CircularInternalAudit']['to_mr'])) ?>
					</div>
				</div>
				<div class="form-group">
