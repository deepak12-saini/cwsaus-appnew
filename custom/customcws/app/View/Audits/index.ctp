	...
	<div class="page-header">
		<h1>Internal Audit Planning &nbsp;&nbsp;&nbsp;
		
		<a href="<?php echo SITEURL.'audits/add'; ?>" class="btn btn-mini btn-info">Add internal Audit Planning </a>
		</h1>
	</div>
			...
			<table class="table table-striped table-bordered table-hover" id="simple-table" >
				...
				<?php 	foreach ($FormatInternalAuditPlanArr as $FormatInternalAuditPlanArrs): 	?>
					<tr>
						...
						<th>							
							<?php 
							if($FormatInternalAuditPlanArrs['FormatInternalAuditPlan']['status'] <  3){
							if($FormatInternalAuditPlanArrs['FormatInternalAuditPlan']['user_id'] == $userid){ ?>
								<a href="<?php echo SITEURL.'audits/edit/'.$FormatInternalAuditPlanArrs['FormatInternalAuditPlan']['id']?>" class="btn btn-mini btn-primary">Edit</a>
							<?php }else{ echo 'N/A'; }  } ?>
						</th>			                    				
					</tr>
					<?php endforeach; ?>
