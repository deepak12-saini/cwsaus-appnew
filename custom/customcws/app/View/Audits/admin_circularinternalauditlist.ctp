			...
			<table class="table table-striped table-bordered table-hover" id="simple-table" >
				...
				<?php 	foreach ($CircularInternalAuditArr as $CircularInternalAuditArrs): 	?>
					<tr>
						...
						<th>							
							<a href="<?php echo SITEURL.'admin/audits/circularinternalauditresult/'.$CircularInternalAuditArrs['CircularInternalAudit']['id']?>" class="btn btn-mini btn-danger">Result</a>							
						</th>			                    				
					</tr>
					<?php endforeach; ?>
