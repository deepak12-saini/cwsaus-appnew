	...
	<div class="page-content">
		<div class="page-header">
			...
			<h1>National Association of Testing Authorities  <small>>> Add New Instrument</small></h1>
		</div>
	
	<div class="row">
		<div class="col-xs-12">
		<?php echo $this->Form->create('Nata',array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
		
			<!-- <div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Equipment Name:</label>
				<div class="col-sm-9">
