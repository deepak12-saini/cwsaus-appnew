<div class="page-content">
		<div class="page-header">
			...
			<?php echo $this->Html->link('Add New',array('controller' => 'natas','action' => 'clienttype_add'),array('class'=>'btn btn-info btn-xs top-button')); ?>	
		...
		<div class="col-xs-12">
			...
			<table class="table table-striped table-bordered table-hover" id="simple-table" >
				...
				<tbody>
					...
					<td>
						<?php echo $this->Html->link('Edit',array('controller' => 'natas','action' => 'clienttype_edit/'.$ClientTypeArrs['NataCategory']['id']),array('class'=>'btn btn-primary btn-xs top-button')); ?>
					</td>
