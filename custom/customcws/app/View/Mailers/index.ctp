<div class="page-content">
		<div class="page-header">
			<h1>EOI Email Logs 
			<?php echo $this->Html->link('Send Mail',array('controller' => 'mailers','action' => 'send'),array('class'=>'btn btn-info btn-xs top-button')); ?>
			
			<?php echo $this->Html->link('Download CSV',array('controller' => 'mailers','action' => 'exportcsv'),array('class'=>'btn btn-warning btn-xs top-button')); ?>
