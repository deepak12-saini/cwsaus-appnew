	...
	<div class="page-content">
		...
		<h1>Project Estimator <small><i class="ace-icon fa fa-angle-double-right"></i> Edit</small>
		</h1>
	</div>
	...
	<div class="row">
		...
		<?php echo $this->Form->create('Estimator',array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea name="data[Estimator][project_description]" id="project_description" class="ckeditor  col-xs-10 col-sm-5" placeholder="Project Description" ><?php echo $docArr['Estimator']['project_description']; ?></textarea>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea name="data[Estimator][estimate]" id="estimate" class="ckeditor  col-xs-10 col-sm-5" placeholder="Result" ><?php echo $docArr['Estimator']['estimate']; ?></textarea>
