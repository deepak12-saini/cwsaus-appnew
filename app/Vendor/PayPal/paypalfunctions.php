...
class Paypalrequest{
	...
	********************************************/
	...
	//'------------------------------------
 	/* $API_UserName="seller_api1.crystalstudios.net";
	$API_Signature="AqiH7xpzk4.3C3w1kJGLrPxwflXMAaH2qKzkQFZP6yGnCX5fOKjyivu3";
	$API_Password="QFGBX3KFW8JFEWJV";  */
	...
	/* 	$this->API_UserName="bharat.oditi169_api1.gmail.com";
		$this->API_Password="1369308176";
		$this->API_Signature="AFcWxV21C7fd0v3bYYYRCpSSRl31AMbrG4bTV1jhpUs0V4ZRJcC3RJS0";   */
		
		$this->API_UserName="seller_api1.crystalstudios.net";
		$this->API_Password="QFGBX3KFW8JFEWJV";
		$this->API_Signature="AqiH7xpzk4.3C3w1kJGLrPxwflXMAaH2qKzkQFZP6yGnCX5fOKjyivu3"; 
	...
	*/
	...
	function CallShortcutExpressCheckout( $paymentAmount, $currencyCodeType, $paymentType, $returnURL, $cancelURL,$billingDescritpion) 
	{
		//------------------------------------------------------------------------------------------------------------------------------------
		...
		$nvpstr = $nvpstr . "&BILLINGAGREEMENTDESCRIPTION=".urlencode($billingDescritpion);
	...
	*/
	...
	'--------------------------------------------------------------------------------------------------------------------------------------------	
	*/
	function ConfirmPayment( $FinalPaymentAmt,$token,$currencyCodeType,$paymentType,$payerID  )
	{
	...
	function CreateRecurringPaymentsProfile($token,$email,$shipToName,$desc,$shipToStreet,$shipToCity,$shipToState,$shipToZip,$shipToCountry,$maintancefee)
	{
		//'--------------------------------------------------------------
		//' At this point, the buyer has completed authorizing the payment
		//' at PayPal.  The function will call PayPal to obtain the details
...
/* 		$token 		= urlencode($_SESSION['TOKEN']);
		...
		$nvpstr.="&PROFILESTARTDATE=".urlencode($StartRecPayDate);
		$nvpstr.="&DESC=".urlencode($desc);
		$nvpstr.="&BILLINGPERIOD=Year";
		$nvpstr.="&BILLINGFREQUENCY=1";
		$nvpstr.="&AMT=".$maintancefee;
	...
	*/
	function hash_call($methodName,$nvpStr)
	{
		...
		//$gv_ApiErrorURL =	$this->gv_ApiErrorURL;
