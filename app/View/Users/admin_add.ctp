	...
	<div class="page-content">
		...
		<h1>Admin User  <small><i class="ace-icon fa fa-angle-double-right"></i> Add New</small>
		</h1>
	</div>
	</div>
	<div class="row">
		...
		<?php echo $this->Form->create('User',array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
			...
			<label for="form-field-2" class="col-sm-3 control-label no-padding-right"> Status : </label>
				...
				<input type="radio" checked="checked" value="1"  class="ace" id="UserActive1" name="data[User][status]"><span class="lbl"> Active</span>
				</label></div>
				
				<div class="radio"><label>
					<input type="radio" value="0"  class="ace" id="UserActive0" name="data[User][status]"><span class="lbl"> Inactive</span>
				</label></div>				
				</div>
			</div>	
			...
			<label for="form-field-2" class="col-sm-3 control-label no-padding-right"> Allow To View Detail : </label>
				...
				<div class="radio"><label>
				<input type="radio"  value="1"  checked class="ace" id="permission_to_view" name="data[User][permission_to_view]"><span class="lbl"> Yes</span>
				</label></div>
				
				<div class="radio"><label>
					<input type="radio" value="0"   class="ace" id="permission_to_view" name="data[User][permission_to_view]"><span class="lbl"> No</span>
				</label></div>				
				</div>
			</div> -->
				<div class="form-group">
			<label for="form-field-2" class="col-sm-3 control-label no-padding-right"> Allow To Add : </label>
				...
				<div class="radio"><label>
				<input type="radio" value="1"  class="ace" id="permission_to_add" name="data[User][permission_to_add]"><span class="lbl"> Yes</span>
				</label></div>
				
				<div class="radio"><label>
					<input type="radio" value="0"  checked class="ace" id="permission_to_add" name="data[User][permission_to_add]"><span class="lbl"> No</span>
				</label></div>				
				</div>
			</div>
				<div class="form-group">
			<label for="form-field-2" class="col-sm-3 control-label no-padding-right"> Allow To Edit : </label>
				...
				<div class="radio"><label>
				<input type="radio"  value="1"  class="ace" id="permission_to_edit" name="data[User][permission_to_edit]"><span class="lbl"> Yes</span>
				</label></div>
				
				<div class="radio"><label>
					<input type="radio" value="0"  checked class="ace" id="permission_to_edit" name="data[User][permission_to_edit]"><span class="lbl"> No</span>
				</label></div>				
				</div>
			</div>
				<div class="form-group">
			<label for="form-field-2" class="col-sm-3 control-label no-padding-right"> Allow To Delete : </label>
				...
				<div class="radio"><label>
				<input type="radio" checked="checked" value="1"  class="ace" id="permission_to_delete" name="data[User][permission_to_delete]"><span class="lbl"> Yes</span>
				</label></div>
				
				<div class="radio"><label>
					<input type="radio" value="0"  checked class="ace" id="permission_to_delete" name="data[User][permission_to_delete]"><span class="lbl"> No</span>
				</label></div>				
				</div>
			</div>
				<div class="form-group">
			<label for="form-field-2" class="col-sm-3 control-label no-padding-right"> Allow To export : </label>
				...
				<div class="radio"><label>
				<input type="radio" checked="checked" value="1"  class="ace" id="permission_to_export" name="data[User][permission_to_export]"><span class="lbl"> Yes</span>
				</label></div>
				
				<div class="radio"><label>
					<input type="radio" value="0"  checked class="ace" id="permission_to_export" name="data[User][permission_to_export]"><span class="lbl"> No</span>
				</label></div>				
				</div>
			</div>
				<div class="form-group">
				...
				<div class="radio"><label>
				<input type="radio" checked="checked" value="1"  class="ace" id="permission_to_upload" name="data[User][permission_to_upload]"><span class="lbl"> Yes</span>
				</label></div>
				
				<div class="radio"><label>
					<input type="radio" value="0"  checked class="ace" id="permission_to_upload" name="data[User][permission_to_upload]"><span class="lbl"> No</span>
				</label></div>				
				</div>
			</div>
			<div class="form-group">
