  ...
  <tr>   
    ...
    <p style="background: #f8fad7; padding-top:15px; border-top: 1px solid #e2e2e2; padding-right:0; padding-left:0; text-align:left; font-family:Arial; font-size:18px; color:#333333;">Hello <?php echo $receiver_name; ?> ,</p>
     <p style="background: #f8fad7; padding-right: 35px; padding-left: 35px; text-align: left; font-family: Arial; color: rgb(51, 51, 51); padding-top: 8px; font-size: 18px;"> </p>
		...
		<tr style="background: #f8fad7;">	
			<td>
			<table width="570" cellpadding="0" cellspacing="0" style="">
			<tr>
				<td align="center"><table align="center" border="0" cellspacing="0" cellpadding="0" style="border-bottom: 1px solid #e2e2e2; float: left; padding: 7px 0; width: 100%;">
						<tr>
							<td style="float: left; color: #333; font-size: 21px;  font-weight: 300; margin:0; font-family:arial;"><h3 style="float: left; color: #333; font-size: 21px;  font-weight: 300;  margin: 4px 0 0; width: 310px; font-family:arial;"><?php echo $top_content['ClientPlan']['client_fname']; ?>'s Receipt</h3></td>
							<td style="border-left: 1px solid #e2e2e2;   display: inline;   float: right;   padding: 0 0 0 20px; font-family:arial;"><p style="font-size: 13px; font-family:arial; font-weight: 400; color: #333; margin: 0;">Order Id: <span style="color: #d45424;">#<?php echo $top_content['ClientPlan']['unique_id'];?></span></p>
			...
			font-weight: bold;  margin: 0 0 0 6px;"><?php echo $transaction_id; ?></span></p>
					...
					<table align="center" border="0" cellspacing="0" cellpadding="0" style="background: #fff; float: left; margin:0; padding:0 10px;width: 100%;">
						<tr>
							
								<h6 style="color: #505050; float: left; font-size: 20px;  font-weight: 600; margin:0 0 8px; padding:0; text-align:right; width:100%;"> <span style=" display: inline-block; font-family: arial; font-size: 16px; font-weight: lighter;">Annual Fee:</span> $<?php echo $top_content['ClientPlan']['rec_fee']; ?></h6></td>
						</tr>
					</table>
			...
			width: 100%;"><span style="color: #505050; display: inline-block; font-size: 18px; font-weight: 300;">Total amount:</span>$<?php echo $top_content['ClientPlan']['rec_fee']; ?></h6></td>
						</tr>
					</table>
