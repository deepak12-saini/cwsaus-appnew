...
<table align="center" border="0" cellspacing="0" cellpadding="0" style="background: #f8fad7; border-bottom: 1px solid #e2e2e2; float: left; padding: 7px 0; width: 100%;">
						<tr>
							<td style="background: #f8fad7; float: left; color: #333; font-size: 21px;  font-weight: 300; margin:0; font-family:arial;"><h3 style="float: left; color: #333; font-size: 21px;  font-weight: 300;  margin: 4px 0 0; width: 310px; font-family:arial;"><?php echo $top_content['ClientPlan']['client_fname']; ?>'s pending invoice</h3></td>
