  ...
  <table class="mobresponsive" style="width:800px; margin:30px auto; background:#f8f8f8; padding: 30px;">
	  <tr>
		...
		<table style="text-align: center; float: left; width: 100%; border-bottom: 1px solid rgb(240, 240, 240); padding:0 20px 8px; margin: 15px 0px 20px;">
			<tr>
				<td style="color:#231f20;float: left;font-size:15px; line-height: 24px;font-weight:500;margin: 0;padding: 0 0 9px; width: 100%;"><?php echo ucfirst($name); ?> has made request for solor business. Please follow up and give response quickly.</td>
			</tr>
			<tr>
