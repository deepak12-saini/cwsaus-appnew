...
<head>
	...
	?>
		...
		<link rel="stylesheet" href="<?php echo SITEURL ;?>theme/css/ace-skins.css" class="ace-main-stylesheet" id="main-ace-style" />
		...
		<script type="text/javascript" src="<?php echo SITEURL ;?>theme/js/jquery.fancybox.js?v=2.1.5"></script>
		<link rel="stylesheet" type="text/css" href="<?php echo SITEURL ;?>theme/css/jquery.fancybox.css?v=2.1.5" media="screen" />
<style>	
.ValidationErrors{
    color: #d00;
